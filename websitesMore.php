<?php
/**
 * Plik zawierajacy widok szczegolow strony internetowej.
 * 
 * @category Components
 * @package  PastaCRM
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> <?php echo $siteTitle ?>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                ?>
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td colspan="2"><?php echo $website_data['date_created'] ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-underline"></i> Nazwa strony</th>
                            <td colspan="2"><?php echo $website_data['name']; ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-link"></i> Adres internetowy</th>
                            <td colspan="2"><a href="http://<?php echo $website_data['web_address']; ?>" target="_blank"><?php echo $website_data['web_address']; ?></a></td>
                        </tr>
                        <tr>
                            ...
                            <td><?php echo $server_data['expires_date']; ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-database"></i> Dostawca domeny</th>
                            <td><?php echo $domain_provider['provider_name']; ?></td>
                            <td><?php echo $website_data['domain_expire_date']; ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-lock"></i> Dostawca SSL</th>
                            <td><?php echo $ssl_provider['provider_name']; ?></td>
                            <td><?php echo $website_data['ssl_expire_date']; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><?php echo $website_data['payment_for_me_date']; ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-cogs"></i> Status</th>
                            <td colspan="2"><?php echo getStatusName($website_data['status']) ?></td>
                        </tr>
                        <tr>
                            <th><i class="fa fa-wordpress"></i> CMS</th>
                            <td colspan="2"><?php echo getCmsName($website_data['cms']); ?></td>
                        </tr>
                        <tr>
                            <th colspan="3"><i class="fa fa-info-circle"></i> Dodatkowe informacje</th>
                        </tr>
                        <tr>
                            <td colspan="3"><?php echo nl2br(bbCode($website_data['comment'])); ?></td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="clientsMore.php?id_u=<?php echo $client_data['id_unique']; ?>"><?php echo $client_data['first_name']; ?> <?php echo $client_data['second_name']; ?></a></td>
                        </tr>
                        <tr>
