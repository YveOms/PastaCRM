                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-fw fa-laptop"></i> <a href="<?= "computerServiceMore.php?id_u=".$id_u ?>">Szczegóły zlecenia</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-pencil-square-o"></i> <?= $siteTitle ?>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="date" class="form-control" name="date_start" id="date_start" value="<?= $service_info['date_start'] ?>" autocomplete="off" required>
                        </td>
                    </tr>
                    <tr>
                        <th><i class="fa fa-fw fa-calendar"></i> Data zakończenia</th>
                        <td>
                            <input type="date" class="form-control" name="date_end" id="date_end" value="<?= $service_info['date_end'] ?>" autocomplete="off">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan=2>
                            <textarea class="form-control" name="comment" placeholder="Opis wykonanych czynności" rows="10"><?= $service_info['comment'] ?></textarea>
                            <font color="grey">
                ...
                <a href="computerServiceMore.php?id_u=<?= $id_u ?>" class="btn btn-primary">
        ...
        <div class="col-lg-6">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <br/>
                    <form action="?id_u=<?= $id_u ?>&status=uploadFile" method="post" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-success" type="button" onclick="addNewPayment('computer_service', '<?= $service_info['id'] ?>')"><i class="fa fa-plus"></i> Dodaj płatność</button>
                    </div>
                    </form>
                </div>
            </div>
